...
import { Loader2, CreditCard, MapPin, User, ArrowLeft, Lock, QrCode, Copy, Check, X, Eye, EyeOff } from "lucide-react";
                                                    ...
                                                    <div className="space-y-2 relative">
                                                        ...
                                                        <div className="relative">
                                                            <Input
                                                                ...
                                                                required
                                                                className={formData.password && formData.password.length < 8 ? "border-yellow-500" : ""}
                                                            />
                                                            <button
                                                                type="button"
                                                        ...
                                                        <p className="text-xs text-muted-foreground">
                                                            Mínimo de 8 caracteres. Use letras e números para maior segurança.
                                                        </p>
                                                    </div>
