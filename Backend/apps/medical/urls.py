...
from .views import SlotsView, ScheduleAppointmentView, RescheduleAppointmentView, PatientEvolutionView, DoctorPatientPhotosView, DoctorDashboardStatsView, UpdateDoctorPhotoView, DoctorAvailabilityView
